...
urlpatterns = [
    ...
    path('projects/timeline/8/', views.Timeline8View.as_view()),
    ...
    path('projects/ann/8/', views.Ann8View.as_view()),
    path('projects/ann/9/', views.Ann9View.as_view()),
    path('projects/ann/10/', views.Ann10View.as_view()),
    ...
    path('projects/rikako/', views.RikakoView.as_view()),
]
